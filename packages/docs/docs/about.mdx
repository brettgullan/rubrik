...
It builds on established libraries and best-practices to provide highly customizable, ready-to-use components.
...
* Extend, adapt and re-use, rather than re-build.  The authors have attempted to use best-of-breed libraries and existing components, and adapted them to fit within the Rubrik paradigm.
